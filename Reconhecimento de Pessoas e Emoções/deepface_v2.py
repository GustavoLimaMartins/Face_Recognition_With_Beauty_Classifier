...
def detect_faces_and_emotions(video_path, output_path, known_face_encodings, known_face_names):
    ...
    try:
        ...
        # Alguns ambientes não possuem suporte a janelas (HighGUI)
        pass
...
input_video_path = os.path.join(script_dir, 'Emoções.mp4')  # Substitua 'meu_video.mp4' pelo nome do seu vídeo
