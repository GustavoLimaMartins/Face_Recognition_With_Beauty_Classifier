...
def main():
    ...
    video_path = os.path.join(script_dir, 'centesimoRC.mp4')  # Video de entrada
    audio_path = os.path.join(script_dir, 'centesimoRC.wav')
    text_output_path = os.path.join(script_dir, 'transcricao1_centesimoRC.txt')
